    ...
    UNSAFE_componentWillReceiveProps = (nextProps) => {
        ...
        if (this.props.loading !== nextProps.loading) {
            ...
            if (nextProps.loading === true) {
                ...
                } else if (nextProps.loadingText === "獲取下載網址...") {
                    if (
                        pathHelper.isSharePage(this.props.location.pathname) &&
                        this.props.share &&
                        this.props.share.score > 0
        ...
        return (
            <div>
                ...
                <Dialog
                    ...
                    aria-labelledby="form-dialog-title"
                >
                    <DialogTitle id="form-dialog-title">建立資料夾</DialogTitle>
                ...
                <Dialog
                    ...
                    aria-labelledby="form-dialog-title"
                >
                    <DialogTitle id="form-dialog-title">建立文件</DialogTitle>
                ...
                <Dialog
                    ...
                    aria-labelledby="form-dialog-title"
                >
                    <DialogTitle id="form-dialog-title">刪除物件</DialogTitle>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            ...
                            {this.props.selected.length > 1 && (
                                <span>
                                    這{this.props.selected.length}個物件
                                </span>
                            )}
                            嗎？
                        </DialogContentText>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            <TextField
                                ...
                                placeholder="輸入文件下載網址，支援 HTTP(s)/FTP/磁力鏈"
                            />
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
