        ...
        return (
            <div>
                ...
                <Dialog
                    ...
                    onClose={this.handleClose}
                >
                    <DialogTitle>修改登入密碼</DialogTitle>
                    <DialogContent>
                        <div>
                            <TextField
                                id="standard-name"
                    ...
                    <DialogContent>
                        <div className={classes.flexContainerResponse}>
                            ...
                            <div className={classes.desText}>
                                {!this.state.settings.two_factor && (
                                    <Typography>
                                        請使用任意二步驗證APP或者支援二步驗證的密碼管理軟體掃描左側二維碼添加本站。掃描完成後請填寫二步驗證APP給出的6位驗證碼以開啟二步驗證。
                                    </Typography>
                                )}
                                {this.state.settings.two_factor && (
                                    <Typography>
                ...
                <Dialog
                    ...
                    onClose={this.handleClose}
                >
                    <DialogTitle>WebDAV連接地址</DialogTitle>
                    <DialogContent>
                        <TextField
                            id="standard-name"
                            className={classes.textField}
